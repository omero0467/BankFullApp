...
import { depositToAccount, getAccount,withdrawFromAccount, transfer, deleteAccount} from "../services/bank_accounts.mongoose.js";
...
accountsRouter.get('/:id',(req,res,next) => {checkTheReqBody(['_id'],req.body,res,next)}, getAccount)
...
accountsRouter.delete("/",(req,res,next) => {checkTheReqBody(['_id'],req.body,res,next)},deleteAccount)
